...
const PricingFeature: React.FC<PricingFeatureProps> = ({ 
  ...
  return (
    <li className="flex items-center gap-[12px]">
      {included ? (
        <svg
          className={`w-4 h-4 ${usePurpleIcon ? "text-purple" : "text-black"}`}
        ...
        <svg
          className="w-4 h-4 text-disabled-gray"
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
          viewBox="0 0 16 16"
      ...
      <span
        className={`${
          included
            ? "text-black"
            : "text-disabled-gray line-through leading-[150%] font-[400]"
        }`}
      >
        {name}
      </span>
