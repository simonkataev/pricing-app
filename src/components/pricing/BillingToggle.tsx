...
const BillingToggle: React.FC<BillingToggleProps> = ({ billingCycle, onChange }) => {
  return (
    <div className="inline-flex p-[4px] items-center gap-[8px] rounded-lg bg-light-gray" role="group">
      <button
        type="button"
        className={`flex py-[6px] px-[20px] justify-center items-center gap-[10px] rounded-md font-inter text-sm font-medium leading-normal tracking-[0.14px] transition-colors ${
